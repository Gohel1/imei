...
```
cd existing_repo
git remote add origin https://gitlab.com/big-kitty-labs/aawellness/portal.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/big-kitty-labs/aawellness/portal/-/settings/integrations)
